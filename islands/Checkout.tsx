...
function Payment(props: { mutate: Mutate; state: State; methods: string[] }) {
  ...
  return (
    <>
      ...
      <button class="mb-5 max-h-16 px-3 py-2 bg-gray-700 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-gray-700">
        Pay now
      </button>
    </>
  );
